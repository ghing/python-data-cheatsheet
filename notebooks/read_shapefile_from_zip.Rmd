...
```python
zipfile_url = "zip://{0}".format(os.path.join(DATA_DIR_SRC, 'grand_blvd.zip', 'grand_blvd', 'grand_blvd.shp'))

zipfile_url
```

Note that because the shapefile is in a subdirectory of the zip file, there's a sub-path that appears after the zip file name in this path.
